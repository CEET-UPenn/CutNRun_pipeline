...
# Create output directory to save normalized bedGraph, bigWig and log files
  ...
  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/SRPMC

# Set current working directory
  cd /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/bam-to-bed
...
# for-loop to create SRPMC normalized bedgraph file with rabbit IgG control
  for f in *.hg38.canonical.clean.fragments.bed; do
    ...
    # Set file names and directories
      ...
      sample_exp_bed="${base}.hg38.canonical.clean.fragments.bed"
      sample_spikein_bed="${base}.ecoli_K12_DH10B.fragments.bed"
      control_exp_bed="CutandRun-Library-40.hg38.canonical.clean.fragments.bed"
      control_spikein_bed="CutandRun-Library-40.ecoli_K12_DH10B.fragments.bed"
      ...
      SRPMC_bedGraph="${base}.hg38.canonical.clean.fragments.SRPMC.bedGraph"
      
      bigWig_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/bigWig
      SRPMC_bigWig="${base}.hg38.canonical.clean.fragments.SRPMC.bw"

      # to create log files
      log_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/SRPMC
      log_file="log_${base}.hg38.canonical.clean.fragments.SRPMC.txt"
    ...
    (
      ...
      /project/voightlab_01/lorenzk/Archive/UCSC_Tools/bedGraphToBigWig \
        $bedGraph_dir/$SRPMC_bedGraph \
