...
# Make directories to save SEACR output and log files
    mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/SEACR
    mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log
    mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/SEACR
...
# for-loop for SEACR peak calling
    for f in *.hg38.canonical.clean.fragments.bedGraph; do
        ...
        SEACR_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/SEACR
        SEACR_log_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/SEACR

        actual_sample_raw="${base}.hg38.canonical.clean.fragments.bedGraph"
        actual_sample_SFRC="${base}.hg38.canonical.clean.fragments.SFRC.bedGraph"
        actual_sample_SRPMC="${base}.hg38.canonical.clean.fragments.SRPMC.bedGraph"

        IgG_control_raw="CutandRun-Library-40.hg38.canonical.clean.fragments.bedGraph"
        IgG_control_SFRC="CutandRun-Library-40.hg38.canonical.clean.fragments.SFRC.bedGraph"
        IgG_control_SRPMC="CutandRun-Library-40.hg38.canonical.clean.fragments.SRPMC.bedGraph"

        output_raw_wo_IgG="${base}.hg38.canonical.clean.fragments_SEACR-wo-IgG-norm"
        output_raw_w_IgG="${base}.hg38.canonical.clean.fragments_SEACR-w-IgG-norm"

        output_SFRC_wo_IgG="${base}.hg38.canonical.clean.fragments.SFRC_SEACR-wo-IgG"
        output_SFRC_w_IgG="${base}.hg38.canonical.clean.fragments.SFRC_SEACR-w-IgG"
        
        output_SRPMC_wo_IgG="${base}.hg38.canonical.clean.fragments.SRPMC_SEACR-wo-IgG"
        output_SRPMC_w_IgG="${base}.hg38.canonical.clean.fragments.SRPMC_SEACR-w-IgG"

        # SEACR peak calling without IgG control, with norm
        (
            /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/SEACR-master/SEACR_1.3.sh \
                $actual_sample_raw \
                0.01 norm stringent \
