...
# Create output directories
  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/BEDPE
  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/bam-to-bed
  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/bedGraph

  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log
  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/bam-to-BEDPE
  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/bam-to-bed
  mkdir -p /project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/bed-to-bedGraph
...
# for-loop to create freagments and raw readcounts files
  for f in *.hg38.canonical.clean.sort.bam; do
    ...
    base=${f%%.hg38.canonical.clean.sort.bam}  # to create raw readcounts bedGraph files
    ...
    # Define files and directories. You can change here to use this script for your data analysis
      ...
      bam_sort_by_coordinate="${base}.hg38.canonical.clean.sort.bam"
      BEDPE_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/BEDPE
      BEDPE="${base}.hg38.canonical.clean.bed"
      filtered_BEDPE="${base}.hg38.canonical.clean.fragments.bed"
      log_BEDPE_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/bam-to-BEDPE
      log_BEDPE="bam-to-BEDPE_log_${base}.hg38.canonical.clean.txt"

      # to create fragments BED files
      bam_sort_by_query_actual="${base}.hg38.canonical.clean.sortn.bam"
      bam_sort_by_query_spike_in="${base}.ecoli_K12_DH10B.sortn.bam"

      bam_to_bed_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/bam-to-bed
      bam_to_bed_actual="${base}.hg38.canonical.clean.sortn.bed"
      bam_to_bed_spike_in="${base}.ecoli_K12_DH10B.sortn.bed"

      filtered_bam_to_bed_actual="${base}.hg38.canonical.clean.fragments.bed"
      filtered_bam_to_bed_spike_in="${base}.ecoli_K12_DH10B.fragments.bed"

      log_bam_to_bed_dir=/project/voightlab_01/lorenzk/CEET/Amatullah/CutRun/Easy-Shells_CUTnRUN/D3PIC/log/bam-to-bed
      log_bam_to_bed_actual="bam-to-bed_log_${base}.hg38.txt"
      log_bam_to_bed_spike_in="bam-to-bed_log_${base}.ecoli_K12_DH10B.txt"
      ...
      raw_bedGraph_actual="${base}.hg38.canonical.clean.fragments.bedGraph"
      raw_bedGraph_spike_in="${base}.ecoli_K12_DH10B.fragments.bedGraph"
